...
//                                                            
// Module   : Transitionals/Transitionals/CheckerboardTransition.xaml.cs
...
namespace Transitionals.Transitions
{
    ...
    {
        private static readonly CheckerboardTransitionFrameworkElement frameworkElement =
            new CheckerboardTransitionFrameworkElement();

        public CheckerboardTransition()
        {
            NewContentStyle = (Style) frameworkElement.FindResource("CheckerboardTransitionNewContentStyle");
            NewContentStoryboard =
                (Storyboard) frameworkElement.FindResource("CheckerboardTransitionNewContentStoryboard");
        }
