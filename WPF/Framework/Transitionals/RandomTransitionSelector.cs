...
//                                                            
// Module   : Transitionals/Transitionals/RandomTransitionSelector.cs
// Name     : Adrian Hum - adrianhum 
// Created  : 2017-09-23-11:00 AM
// Modified : 2017-11-09-2:51 PM
...
namespace Transitionals
{
	...
	public class RandomTransitionSelector : TransitionSelector
	{
	    ...
	    public static readonly DependencyProperty TransitionDurationProperty =
			DependencyProperty.Register("TransitionDurationProperty", typeof(Duration), typeof(RandomTransitionSelector),
				new FrameworkPropertyMetadata(Duration.Automatic, OnTransitionDurationChanged));

	    /// <summary>
	    ///     Identifies the <see cref="TransitionAssembliesProperty" /> dependency property.
	    /// </summary>
	    public static readonly DependencyProperty TransitionAssembliesProperty = DependencyProperty.Register(
			"TransitionAssembliesProperty", typeof(ObservableCollection<AssemblyName>), typeof(RandomTransitionSelector),
			new FrameworkPropertyMetadata(new ObservableCollection<AssemblyName>(),
	    ...
	    /// </summary>
	    public static readonly DependencyProperty TransitionsProperty = DependencyProperty.Register("TransitionsProperty",
			typeof(ObservableCollection<Transition>), typeof(RandomTransitionSelector),
			new FrameworkPropertyMetadata(new ObservableCollection<Transition>(), FrameworkPropertyMetadataOptions.AffectsRender,
	    ...
	    /// <inheritdoc />
	    /// <summary>
	    ///     Returns a random <see cref="T:Transitionals.Transition" /> from the list of
	    ///     <see cref="P:Transitionals.RandomTransitionSelector.Transitions" />.
	    /// </summary>
		...
		{
			get { return (ObservableCollection<AssemblyName>) GetValue(TransitionAssembliesProperty); }
			set { SetValue(TransitionAssembliesProperty, value); }
		}
		...
		{
			get { return (ObservableCollection<Transition>) GetValue(TransitionsProperty); }
